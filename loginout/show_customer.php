        ...
        <div class="showUser">
            <form action="" method="POST">
                <?php
                    ...
                    $sql = "SELECT Customer_Name, Customer_Lastname FROM customer WHERE Username = '$current_username' LIMIT 1";
                    $result = $conn->query($sql);

                    if ($result->num_rows > 0) {
                        $data = $result->fetch_assoc();
                        echo "Customer name: {$data['Customer_Name']} {$data['Customer_Lastname']}";
                    } else {
